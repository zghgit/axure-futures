import greenDown from '../../../assets/img/greenDown.png';
import greenUp from '../../../assets/img/greenUp.png';
import redDown from '../../../assets/img/redDown.png';
    ...
    methods: {
        ...
        candlestickData() {
            ...
            function splitData(rawData) {
                ...
                for (let i = 0; i < 10; i++) {
                    let randomNum = randomMarkPoint(), imgUrl,offsetVal
                    if (rawData[randomNum][1] > rawData[randomNum][0]) {
                        imgUrl =redUp;
                        offsetVal = ['0','50%']
                    } else {
                        imgUrl = greenDown;
                    ...
                    let date = times[randomNum];
                    let closePrice = rawData[randomNum][1];
                    markPointData.push({
                        coord: [date, closePrice],
                        symbol:'image:// ' +  imgUrl,
                        symbolSize:20,
                        symbolOffset:offsetVal
                    });
                }
                return {
                    datas: datas,
            ...
            function randomMarkPoint() {
                return Math.round(Math.random() * 290);
            }
            ...
            candlestickId.on('click', function (params) {
                if(params.componentType==="markPoint"){
                    let option = window.radarId.getOption();
                    window.radarId.clear();
                    window.radarId.setOption(option);
                }
            })
        },
    }
