...
<script>
    ...
    export default {
        ...
        methods: {
            splashesDete() {
                ...
                var data = [
                            [[28604, 77, 17096869, '17', 1990], [31163, 77.4, 27662440, '3', 1990], [1516, 68, 1154605773, '115', 1990], [13670, 74.7, 10582082, '10', 1990], [28599, 75, 4986705, '4', 1990], [29476, 77.1, 56943299, '56', 1990], [31476, 75.4, 78958237, '78', 1990], [28666, 78.1, 254830, '2', 1990], [1777, 57.7, 870601776, '87', 1990], [29550, 79.1, 122249285, '12', 1990], [2076, 67.9, 20194354, '20', 1990], [12087, 72, 42972254, '42', 1990], [24021, 75.4, 3397534, '3', 1990], [43296, 76.8, 4240375, '4', 1990], [10088, 70.8, 38195258, '38', 1990], [19349, 69.6, 147568552, '14', 1990], [10670, 67.3, 53994605, '53', 1990], [26424, 75.7, 57110117, '5', 1990], [37062, 75.4, 252847810, '25', 1990]],
                            [[44056, 81.8, 23968973, '23', 2015], [43294, 81.7, 35939927, '35', 2015], [13334, 76.9, 1376048943, '131', 2015], [21291, 78.5, 11389562, '11', 2015], [38923, 80.8, 5503457, '5', 2015], [37599, 81.9, 64395345, '64', 2015], [44053, 81.1, 80688545, '80', 2015], [42182, 82.8, 329425, '3', 2015], [5903, 66.8, 1311050527, '123', 2015], [36162, 83.5, 126573481, '126', 2015], [1390, 71.4, 25155317, '25', 2015], [34644, 80.7, 50293439, '50', 2015], [34186, 80.6, 4528526, '4', 2015], [64304, 81.6, 5210967, '5', 2015], [24787, 77.3, 38611794, '38', 2015], [23038, 73.13, 143456918, '14', 2015], [19360, 76.5, 78665830, '78', 2015], [38225, 81.4, 64715810, '6', 2015], [53354, 79.1, 321773631, '32', 2015]]
                ];
                let option = {
    ...
    series: [
        ...
        },
        {
            ...
            candlestickData() {
                let candlestickId = this.$echarts.init(document.getElementById('candlestick'));
...
function calculateMA(dayCount) {
  ...
  series: [{
          ...
          data: data.deas
                ...
                candlestickId.setOption(option);
            },
            radarData() {
                let radarId = this.$echarts.init(document.getElementById('radar'));
                let option = {backgroundColor:"#FFF",
            radar: {
              name: {
                textStyle: {
                  color: '#999999',
